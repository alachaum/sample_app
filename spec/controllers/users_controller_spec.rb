...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :email => "another@example.org")
      ...
      describe "who are not administrator" do
      ...
      describe "who are administrator" do
        before(:each) do
          @user.toggle!(:admin)
        end
  ...
  describe "Get 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "hfjks hjk")
      get :show, :id => @user
  ...
  describe "GET 'new'" do
    ...
    describe "for unsigned users" do
      ...
      it "should have an password_confirmation field" do
        get :new
  ...
  describe "authentication of edit/update pages" do
    ...
    describe "for signed-in users" do
      ...
      before(:each) do
        wrong_user = Factory(:user, :email => "user@wronguser.net")
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as an admin user" do
      ...
      it "should prevent from destroying itself" do
        lambda do
