...
describe PasswordResetsController do
  describe "routing" do
    ...
    it "recognizes and generates #index" do
      { :get => "/password_resets" }.should route_to(:controller => "password_resets", :action => "index")
    end
    ...
    it "recognizes and generates #show" do
      { :get => "/password_resets/1" }.should route_to(:controller => "password_resets", :action => "show", :id => "1")
    end
    ...
    it "recognizes and generates #destroy" do
      { :delete => "/password_resets/1" }.should route_to(:controller => "password_resets", :action => "destroy", :id => "1")
    end
